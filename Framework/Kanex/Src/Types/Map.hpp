...
namespace kanex
{
	...
	template<class Archive,class K, class V, class ... Args>
	std::enable_if_t<is_output_serializable<Archive, std::pair<K, V>>::value>
		Save(Archive& ar, const std::map<K, V, Args...>& map)
	{
		static_assert(std::is_default_constructible_v<K> && std::is_default_constructible_v<V>, "K or V not default_construct!");
	...
	template<class Archive,class K, class V, class ... Args>
	std::enable_if_t<is_input_serializable<Archive, std::pair<K, V>>::value>
		Load(Archive& ar, std::map<K, V, Args...>& map)
	{
		static_assert(std::is_default_constructible_v<K> && std::is_default_constructible_v<V>, "K or V not default_construct!");
	...
	template<class Archive, class K, class V, class ... Args>
	std::enable_if_t<is_output_serializable<Archive, std::pair<K, V>>::value>
		Save(Archive& ar, const std::unordered_map<K, V, Args...>& map)
	{
		static_assert(std::is_default_constructible_v<K> && std::is_default_constructible_v<V>, "K or V not default_construct!");
	...
	template<class Archive, class K, class V, class ... Args>
	std::enable_if_t<is_input_serializable<Archive, std::pair<K, V>>::value>
		Load(Archive& ar, std::unordered_map<K, V, Args...>& map)
	{
		static_assert(std::is_default_constructible_v<K> && std::is_default_constructible_v<V>, "K or V not default_construct!");
